...
Font.register({
  ...
  fonts: [
    ...
    { 
      src: 'https://cdnjs.cloudflare.com/ajax/libimport React from 'react';
import { Page, Text, View, Document, StyleSheet, Font, Image } from '@react-pdf/renderer';
import PDFBuildingSectionEskiz from './PDFBuildingSectionEskiz';
    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          {/* Крупный эскиз поперечного разреза на всю ширину */}
...
export default CommercialProposalPDF;s/pdfmake/0.2.9/fonts/Roboto/Roboto-Medium.ttf', 
      fontWeight: 'bold' 
    },
    { 
      src: 'https://cdnjs.cloudflare.com/ajax/libs/pdfmake/0.2.9/fonts/Roboto/Roboto-Medium.ttf', 
